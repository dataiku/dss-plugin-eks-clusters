...
def get_dss_instance_variables ()
    ...
    strt_dt_window = current_date_time + datetime.timedelta(-31)
    ...
    d = {'instance_id': dss_instance_id, 'region': dss_region, 'availability_zone': dss_availability_zone, 'current_dt': current_data_time, 'strt_dt_window': strt_dt_window}
